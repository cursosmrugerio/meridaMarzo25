...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Predicate<Empleado> pe = emp -> emp.getSueldo()<50.0;
		Predicate<Empleado> peMayorEdad = emp -> emp.getEdad()>=18;
	
		System.out.println("***Sueldo < 50 && LongitudNombre > 7");
	...
	static void show(List<Empleado> lista, Predicate<Empleado> pe ) {
		for(Empleado e:lista) 
			if (pe.test(e)) //<EJECUTA LA LAMBA QUE REGRESA EL METODO or()
