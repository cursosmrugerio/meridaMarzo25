...
public class Principal {
	...
	public static void main(String[] args) {
		...
		show(listaObjects); //SI SE PUEDE
		//showTriangulo(listaObjects); //SI SE PUEDE
		...
		//showTriangulo(listaStrings); //NO SE PUEDE
		...
		//show(listaFiguras); //SI SE PUEDE
		//showTriangulo(listaFiguras); //SI SE PUEDE
		...
		//show(listaCirculo); //NO SE PUEDE
		//showTriangulo(listaCirculo); //NO SE PUEDE
		...
		//show(listaCuadrado); //NO SE PUEDE
		//showTriangulo(listaCuadrado); //NO SE PUEDE
		...
		//show(listaTriangulo); //NO SE PUEDE
		//showTriangulo(listaTriangulo); //SI SE PUEDE
	}
	
	//<? super Class> LowerBounded Wildcard
	static void show(List<? super Figura> lista) {
	...
	static void showTriangulo(List<? super Triangulo> lista) {
		for(Object o: lista)
			System.out.println(o);
	}
